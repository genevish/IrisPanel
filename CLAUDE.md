...
- **Frontend**: React 19 + htm (tagged template literals via CDN import maps), Tailwind CSS (CDN play mode)
...
frontend/
  index.html          # Entry point with import maps (React/htm via CDN) + Tailwind
  static/
